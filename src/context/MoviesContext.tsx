...
const MoviesController = ({ children }: any) => {
  ...
  const fetchRelease = async () => {
    ...
    const apiURL = `https://api.themoviedb.org/3/discover/movie?include_adult=false&language=fr-FR&page=1&sort_by=primary_release_date.desc&with_release_type=3&release_date.lte=2023-12-08&with_origin_country=FR&api_key=${API_KEY}`;
